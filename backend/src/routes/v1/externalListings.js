...
const CITIES = [
  'Agra', 'Ahmedabad', 'Amritsar', 'Aurangabad', 'Allahabad (Prayagraj)', 'Ajmer', 'Aizawl',
  'Bengaluru', 'Bhopal', 'Bhubaneswar', 'Bareilly', 'Belgaum', 'Bikaner', 'Bhuvanagiri',
  'Chennai', 'Chandigarh', 'Coimbatore', 'Cuttack', 'Calicut (Kozhikode)',
  'Delhi', 'Dehradun', 'Durgapur', 'Dindigul', 'Davanagere', 'Dharwad',
  'Erode', 'Ernakulam (Kochi)',
  'Faridabad', 'Firozabad', 'Faizabad',
  'Guwahati', 'Gwalior', 'Gandhinagar', 'Guntur', 'Gorakhpur', 'Gurgaon (Gurugram)',
  'Hyderabad', 'Hubli', 'Haridwar', 'Hissar', 'Hospet',
  'Indore', 'Imphal', 'Itanagar',
  'Jaipur', 'Jodhpur', 'Jabalpur', 'Jammu', 'Jamshedpur', 'Jhansi', 'Jamnagar',
  'Kolkata', 'Kochi', 'Kanpur', 'Kozhikode', 'Kottayam', 'Kurnool', 'Karimnagar',
  ...
  'Ooty (Udhagamandalam)', 'Ongole',
  'Pune', 'Patna', 'Pondicherry (Puducherry)', 'Prayagraj', 'Palakkad', 'Patiala',
  'Quilon (Kollam)',
  'Raipur', 'Ranchi', 'Rajkot', 'Rourkela', 'Rajahmundry',
  'Surat', 'Srinagar', 'Shimla', 'Salem', 'Srikakulam', 'Shillong', 'Siliguri',
  'Thiruvananthapuram', 'Tirunelveli', 'Tirupur', 'Tiruchirappalli (Trichy)', 'Thane', 'Thooththukudi (Tuticorin)', 'Thanjavur',
  'Udaipur', 'Ujjain', 'Udupi',
  'Visakhapatnam (Vizag)', 'Vijayawada', 'Varanasi', 'Vadodara', 'Vellore',
  'Warangal', 'Wadhwan',
  'Yadgir', 'Yamunanagar',
  'Zunheboto (Nagaland)'
];
...
const CITY_BASE_COORDS = {
  ...
  'Ooty (Udhagamandalam)': [11.4102, 76.6950],
  ...
  'Thooththukudi (Tuticorin)': [8.7642, 78.1348],
  ...
  'Zunheboto (Nagaland)': [25.9723, 94.5208]
};
